...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Header Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-900/40 via-indigo-900/30 to-purple-900/20 border border-default p-8">
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="mt-6 flex items-center space-x-4">
            <Link
              to="/decisions/create"
              className="inline-flex items-center space-x-2 px-5 py-3 rounded-xl bg-primary hover:bg-blue-500 text-white font-semibold text-sm transition-all shadow-app shadow-blue-600/25"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-slate-900/80 border border-default rounded-2xl p-5 flex items-center space-x-4">
          <div className="w-12 h-12 rounded-xl bg-blue-500/10 text-blue-400 flex items-center justify-center">
            <Vote className="w-6 h-6" />
          </div>
          <div>
            <p className="text-xs text-secondary font-medium">Total Decisions</p>
        ...
        <div className="bg-slate-900/80 border border-default rounded-2xl p-5 flex items-center space-x-4">
          ...
          <div>
            <p className="text-xs text-secondary font-medium">Active (Open)</p>
        ...
        <div className="bg-slate-900/80 border border-default rounded-2xl p-5 flex items-center space-x-4">
          ...
          <div>
            <p className="text-xs text-secondary font-medium">Closed</p>
        ...
        <div className="bg-slate-900/80 border border-default rounded-2xl p-5 flex items-center space-x-4">
          ...
          <div>
            <p className="text-xs text-secondary font-medium">Linked Polls</p>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-900/60 p-4 rounded-2xl border border-default">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full bg-background border border-default rounded-xl pl-10 pr-4 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500"
          />
        </div>
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors ${
                statusFilter === status
                  ...
                  : 'bg-surface text-secondary hover:text-slate-200'
              }`}
            >
              {status}
            </button>
      ...
      {filteredDecisions.length === 0 ? (
        <div className="py-16 text-center bg-slate-900/40 border border-default rounded-3xl p-8">
          ...
          <Link
            to="/decisions/create"
            className="inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl bg-primary hover:bg-blue-500 text-white font-medium text-sm transition-all"
          >
