        ...
        <section className="relative hidden overflow-hidden bg-[linear-gradient(180deg,#f8fbff_0%,#eef4ff_100%)] px-8 py-10 md:flex md:flex-col md:justify-between lg:px-12 lg:py-12">
          ...
          <div className="relative z-10 flex items-end justify-center">
            <svg viewBox="0 0 520 360" className="h-auto w-full max-w-[30rem] drop-shadow-md" aria-hidden="true">
              <defs>
                <linearGradient id="sceneWashSignup" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#f7fbff" />
                  <stop offset="55%" stopColor="#eef4ff" />
                  <stop offset="100%" stopColor="#e8f2ff" />
                </linearGradient>
                <linearGradient id="orbBlueSignup" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#93c5fd" stopOpacity="0.85" />
                  <stop offset="100%" stopColor="#60a5fa" stopOpacity="0.08" />
                </linearGradient>
                <linearGradient id="laptopBodySignup" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#475569" />
                  <stop offset="100%" stopColor="#0f172a" />
                </linearGradient>
                <linearGradient id="screenInnerSignup" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#0f172a" />
                  <stop offset="100%" stopColor="#111827" />
                </linearGradient>
                <linearGradient id="screenGlowSignup" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#60a5fa" stopOpacity="0.7" />
                  <stop offset="100%" stopColor="#60a5fa" stopOpacity="0" />
                </linearGradient>
                <linearGradient id="skinWarmSignup" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#fde2c8" />
                  <stop offset="100%" stopColor="#f2b98c" />
                </linearGradient>
                <linearGradient id="hairDarkSignup" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#1f2937" />
                  <stop offset="100%" stopColor="#0f172a" />
                </linearGradient>
                <linearGradient id="clothBlueSignup" x1="0%" y1="0%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#3b82f6" />
                  <stop offset="100%" stopColor="#1d4ed8" />
                </linearGradient>
                <filter id="softShadowSignup" x="-20%" y="-20%" width="140%" height="140%">
                  <feDropShadow dx="0" dy="12" stdDeviation="12" floodColor="#0f172a" floodOpacity="0.12" />
                </filter>
                <filter id="glowSignup" x="-30%" y="-30%" width="160%" height="160%">
                  <feDropShadow dx="0" dy="0" stdDeviation="16" floodColor="#60a5fa" floodOpacity="0.32" />
                </filter>
              </defs>

              <rect x="34" y="38" width="452" height="264" rx="46" fill="url(#sceneWashSignup)" opacity="0.72" />
              <motion.ellipse
                cx="150"
                cy="86"
                rx="62"
              ...
              <AnimatePresence>
                {isFocused && (
                  <motion.polygon
                    ...
                    fill="url(#screenGlowSignup)"
                    style={{ originY: 1, filter: 'url(#glowSignup)' }}
                  />
                )}
              </AnimatePresence>
              ...
              <motion.g
                ...
                filter="url(#softShadowSignup)"
              >
                <rect x="154" y="132" width="112" height="78" rx="18" fill="url(#laptopBodySignup)" />
                <rect x="161" y="139" width="98" height="64" rx="12" fill="url(#screenInnerSignup)" />
              ...
              >
                ...
                <circle cx="118" cy="158" r="25" fill="url(#skinWarmSignup)" />
                <path d="M95 160C95 136 113 123 131 126C144 128 154 138 156 150C158 160 155 167 150 171C146 160 140 152 131 149C121 146 108 147 95 160Z" fill="url(#hairDarkSignup)" />
              ...
              <motion.g
                ...
                className="cursor-pointer"
              >
                <path d="M173 276C173 223 194 186 260 186C326 186 347 223 347 276C347 281 343 285 338 285H182C177 285 173 281 173 276Z" fill="url(#clothBlueSignup)" />
                <path d="M223 189C231 177 244 171 260 171C276 171 289 177 297 189L297 209H223Z" fill="#dbeafe" opacity="0.95" />
                <circle cx="260" cy="146" r="29" fill="url(#skinWarmSignup)" />
                <path d="M233 149C234 126 249 114 268 114C288 114 304 128 308 151C309 163 306 171 302 176C297 168 290 161 280 157C270 153 247 152 233 149Z" fill="url(#hairDarkSignup)" />
              ...
              >
                ...
                <circle cx="286" cy="158" r="25" fill="url(#skinWarmSignup)" />
        ...
        <section className="flex items-center justify-center bg-white px-5 py-10 sm:px-8 lg:px-12">
          <div className="w-full max-w-md">
            <div className="mb-6">
              ...
              <p className="mt-2 text-sm text-slate-500">Get started with your DecisionHub account</p>
            </div>
            ...
            <form onSubmit={handleSignupSubmit} className="space-y-4">
              <div>
                <label htmlFor="name" className="mb-1.5 block text-xs font-bold uppercase tracking-[0.2em] text-slate-600">
                  Full Name
                </label>
                <input
                  id="name"
              ...
              <div>
                <label htmlFor="signup-email" className="mb-1.5 block text-xs font-bold uppercase tracking-[0.2em] text-slate-600">
                  Email Address
                </label>
                <input
                  id="signup-email"
              ...
              <div>
                <label htmlFor="signup-password" className="mb-1.5 block text-xs font-bold uppercase tracking-[0.2em] text-slate-600">
                  Password
                </label>
                <input
                  id="signup-password"
              ...
              <div>
                <label htmlFor="confirmPassword" className="mb-1.5 block text-xs font-bold uppercase tracking-[0.2em] text-slate-600">
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
